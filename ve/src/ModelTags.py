...
class GtProcess(object):
    ...
    def __init__(self, work_dir):
        ...
        GtProcess.proc_list.append(self)
...
class ModelGTags(object):
    ...
    '''
    # TODO: global命令支持设定GTAGS联合查询，但是可能需要在项目管理上，可以设定相关性。
