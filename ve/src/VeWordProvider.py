...
#                 #str, str, GdkPixbuf.Pixbuf, str
#                 GtkSource.CompletionItem.new("Proposal 1", "Pro1", None, 'One Proposal'),
#                 GtkSource.CompletionItem.new("Proposal 2", "Pro2", None, 'Second Proposal')
#                 ]
        if self.completion_tags is None or len(self.completion_tags) == 0:
            return []
